...
The adjustment approach is implemented in the function `adjust.outcome.for.x` in the R package [xsynthdid](link on Github).
...
### Variation 2: Correlated x and basic time trend
...
Another point not touched in this paper is how to correctly compute standard errors so that the uncertainty from estimating the adjusted outcome is taken into account. 
